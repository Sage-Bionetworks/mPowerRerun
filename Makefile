...
all: project raw_features processed_features filtered_healthcodes analyses figures
regenerate_paper_results: processed_features replicate_healthcodes analyses figures
...
filtered_healthcodes: clean_log
...
replicate_healthcodes: clean_log
